...
const CONTAINERS = [
    {
        ...
        slots: 2, stats: { moveSpeed: -1.00 }, shielding: { radiation: -2.00 }
    },
    {
        id: 'container_x1',
        ...
        slots: 1, stats: { }, shielding: { radiation: -1.00 }
    },
    {
        id: 'pka_2',
    ...
    },
    {
        ...
        slots: 4, stats: {  }, shielding: { radiation: -2.50 }
    },
    {
        id: 'container_radiy',
        ...
        slots: 5, stats: {  }, shielding: { radiation: -1.00 }
    },
    {
        id: 'pka_4m',
        ...
        slots: 4, stats: {moveSpeed: 2.00}, shielding: { radiation: -6.00 }
    },
    {
        id: 'container_bariy',
...
const ARMORS = [
    ...
    },
    {
        ...
        type: 'Боевые', typeEn: 'Combat',
        containerTypes: ['all'],
        stats: { radiationProtection: 200, bioProtection: 200, thermalProtection: 100, psiProtection: 200, heatResistance: 80, chemResistance: 80, electroResistance: 80, impactResistance: 182, tearProtection: 218, bulletResistance: 292, maxStamina: -10.00, maxWeight: 20.00 },
        enhancement: ENHANCEMENT_PRESETS.combat
    },
    {
        id: 'shturm',
...
const ARTIFACTS = [
    ...
    { id: 'meat_chunk', name: 'Ломоть мяса', nameEn: 'Meat Chunk', category: 'gravity', tier: 2, image: 'meat_chunk.png', imageFolder: 'Artifacts', price: 13500, stats: { bleeding: -0.75, regeneration: 1.50, radiation: 1.50 } },
    ...
    { id: 'kolobok', name: 'Колобок', nameEn: 'Kolobok', category: 'chemical', tier: 3, image: 'kolobok.png', imageFolder: 'Artifacts', price: 78000, stats: { bleeding: -1.50, regeneration: 2.00, radiation: 2.00 } },
    ...
    { id: 'moonlight', name: 'Лунный свет', nameEn: 'Moonlight', category: 'electric', tier: 2, image: 'moonlight.png', imageFolder: 'Artifacts', price: 22000, stats: { psiProtection: 45, moveSpeed: 2.25, bleeding: 1.00, electroResistance: -20 } },
    ...
    { id: 'halogen', name: 'Галоген', nameEn: 'Halogen', category: 'electric', tier: 3, image: 'halogen.png', imageFolder: 'Artifacts', price: 61000, stats: { psiProtection: 120, maxStamina: 10.00, moveSpeed: 3.50, bleeding: 1.20 } },
    ...
    { id: 'eye', name: 'Глаз', nameEn: 'Eye', category: 'thermal', tier: 2, image: 'eye.png', imageFolder: 'Artifacts', price: 19350, stats: { thermalProtection: 30, bleeding: -2.00, heatResistance: 20, radiation: 1.00 } },
    { id: 'flame', name: 'Пламя', nameEn: 'Flame', category: 'thermal', tier: 3, image: 'flame.png', imageFolder: 'Artifacts', price: 32000, stats: { frostProtection: 40, thermalProtection: 80, bleeding: -4.00, radiation: 3.00 } },
    { id: 'fire_loop', name: 'Огненная петля', nameEn: 'Fire Loop', category: 'thermal', tier: 3, image: 'fire_loop.png', imageFolder: 'Artifacts', price: 36000, stats: { regeneration: 3.00, bleeding: 1.50, moveSpeed: -0.50 } },
    ...
    { id: 'medallion', name: 'Медальон', nameEn: 'Medallion', category: 'unique', tier: 3, image: 'medallion.png', imageFolder: 'Artifacts', price: null, priceText: 'Нельзя продать', priceTextEn: 'Cannot sell', stats: { bleeding: -2.00, maxWeight: 10.00, regeneration: 3.00 } },
    ...
    { id: 'goblet_thermal', name: 'Бокал (терма)', nameEn: 'Goblet (Thermal)', category: 'unique', tier: 2, image: 'goblet_thermal.png', imageFolder: 'Artifacts', price: null, priceText: 'Нельзя продать', priceTextEn: 'Cannot sell', stats: { bleeding: -0.50, regeneration: 1.50, radiation: 1.00 } },
    // FROST (EVENT)
...
const WEAPONS = [
    ...
    // ASSAULT RIFLES & MACHINE GUNS (Коэффициент 0.8 + Данные из CSV)
    { 
        id: 'aek971', image: 'aek971.png', imageFolder: 'Weapons', name: 'АЕК-971', nameEn: 'AEK-971', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 33, rpm: 900, headshotMult: 1.25, effectiveRange: 19, maxRange: 80, fireModes: ['auto', 'single'], 
        bleeding: 0.02, damageFalloff: { end: 80, minScale: 0.8 },
        ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp'], 
        stats: { verticalRecoil: 1.22, horizontalRecoil: 0.2, hipSpread: 0.49, adsSpread: 0.2 } 
    },
    { 
        id: 'lr300', image: 'lr300.png', imageFolder: 'Weapons', name: 'LR-300', nameEn: 'LR-300', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 31, rpm: 920, headshotMult: 1.25, effectiveRange: 20, maxRange: 80, fireModes: ['auto', 'single'], 
        bleeding: 0.0194, damageFalloff: { end: 80, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.2, horizontalRecoil: 0.22, hipSpread: 0.53, adsSpread: 0.19 } 
    },
    { 
        id: 'fn_f2000_tactical', image: 'fn_f2000_tactical.png', imageFolder: 'Weapons', name: 'FN F2000 Tactical', nameEn: 'FN F2000 Tactical', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 35, rpm: 800, headshotMult: 1.25, effectiveRange: 28, maxRange: 120, fireModes: ['auto', 'single'], 
        bleeding: 0.0225, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.05, horizontalRecoil: 0.19, hipSpread: 0.46, adsSpread: 0.16 } 
    },
    { 
        id: 'hk_xm8', image: 'hk_xm8.png', imageFolder: 'Weapons', name: 'HK XM8', nameEn: 'HK XM8', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 34, rpm: 820, headshotMult: 1.25, effectiveRange: 26, maxRange: 120, fireModes: ['auto', 'single'], 
        bleeding: 0.022, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.1, horizontalRecoil: 0.1, hipSpread: 0.54, adsSpread: 0.18 } 
    },
    { 
        id: 'fn_fnc', image: 'fn_fnc.png', imageFolder: 'Weapons', name: 'FN FNC', nameEn: 'FN FNC', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 39, rpm: 700, headshotMult: 1.25, effectiveRange: 28, maxRange: 125, fireModes: ['auto', 'single'], 
        bleeding: 0.0257, damageFalloff: { end: 125, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.32, horizontalRecoil: 0.25, hipSpread: 0.48, adsSpread: 0.14 } 
    },
    { 
        id: 'hk416', image: 'hk416.png', imageFolder: 'Weapons', name: 'HK416', nameEn: 'HK416', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', 
        damage: 32, rpm: 850, headshotMult: 1.25, effectiveRange: 20, maxRange: 90, fireModes: ['auto', 'single'], 
        bleeding: 0.0212, damageFalloff: { end: 90, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.21, horizontalRecoil: 0.22, hipSpread: 0.6, adsSpread: 0.2 } 
    },
    { 
        id: 'fn_f2000', image: 'fn_f2000.png', imageFolder: 'Weapons', name: 'FN F2000', nameEn: 'FN F2000', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', 
        damage: 32, rpm: 850, headshotMult: 1.25, effectiveRange: 26, maxRange: 120, fireModes: ['auto', 'single'], 
        bleeding: 0.0212, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.1, horizontalRecoil: 0.2, hipSpread: 0.61, adsSpread: 0.16 } 
    },
    { 
        id: 'hk_g36', image: 'hk_g36.png', imageFolder: 'Weapons', name: 'HK G36', nameEn: 'HK G36', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', 
        damage: 36, rpm: 750, headshotMult: 1.25, effectiveRange: 25, maxRange: 100, fireModes: ['auto', 'single'], 
        bleeding: 0.024, damageFalloff: { end: 100, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.19, horizontalRecoil: 0.23, hipSpread: 0.65, adsSpread: 0.2 } 
    },
    { 
        id: 'fn_fal', image: 'fn_fal.png', imageFolder: 'Weapons', name: 'FN FAL', nameEn: 'FN FAL', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 38, rpm: 650, headshotMult: 1.25, effectiveRange: 20, maxRange: 80, magazine: 20, fireModes: ['auto', 'single'], 
        bleeding: 0.0386, damageFalloff: { end: 80, minScale: 0.8 },
        ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], 
        stats: { verticalRecoil: 1.65, horizontalRecoil: 0.58, hipSpread: 0.72, adsSpread: 0.12 } 
    },
    { 
        id: 'ak12', image: 'ak12.png', imageFolder: 'Weapons', name: 'АК-12', nameEn: 'AK-12', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', 
        damage: 38, rpm: 690, headshotMult: 1.25, effectiveRange: 25, maxRange: 120, fireModes: ['auto', 'single'], 
        bleeding: 0.026, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp', '545x39_bs'], 
        stats: { verticalRecoil: 1.32, horizontalRecoil: 0.29, hipSpread: 0.53, adsSpread: 0.15 } 
    },
    { 
        id: 'pkp_pecheneg', image: 'pkp_pecheneg.png', imageFolder: 'Weapons', name: 'ПКП «Печенег»', nameEn: 'PKP "Pecheneg"', category: 'machinegun', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 40, rpm: 650, headshotMult: 1.25, effectiveRange: 25, maxRange: 125, fireModes: ['auto'], 
        bleeding: 0.0415, damageFalloff: { end: 125, minScale: 0.8 },
        ammoTypes: ['762x54_pp', '762x54_exp'], 
        stats: { verticalRecoil: 1.62, horizontalRecoil: 0.6, hipSpread: 1.2, adsSpread: 0.23 } 
    },
    { 
        id: 'pkm', image: 'pkm.png', imageFolder: 'Weapons', name: 'ПКМ', nameEn: 'PKM', category: 'machinegun', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 40, rpm: 650, headshotMult: 1.25, effectiveRange: 23, maxRange: 125, fireModes: ['auto'], 
        bleeding: 0.0415, damageFalloff: { end: 125, minScale: 0.8 },
        ammoTypes: ['762x54_pp', '762x54_exp'], 
        stats: { verticalRecoil: 1.66, horizontalRecoil: 0.6, hipSpread: 1.2, adsSpread: 0.24 } 
    },
    { 
        id: 'vsk94', image: 'vsk94.png', imageFolder: 'Weapons', name: 'ВСК-94', nameEn: 'VSK-94', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 37, rpm: 700, headshotMult: 1.35, effectiveRange: 25, maxRange: 120, magazine: 20, fireModes: ['auto', 'single'], 
        bleeding: 0.0309, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['9x39_sp5', '9x39_sp6', '9x39_exp'], 
        stats: { verticalRecoil: 1.03, horizontalRecoil: 0.1, hipSpread: 2.5, adsSpread: 0.1 } 
    },
    { 
        id: 'vss_vintorez', image: 'vss_vintorez.png', imageFolder: 'Weapons', name: 'ВСС «Винторез»', nameEn: 'VSS "Vintorez"', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 37, rpm: 700, headshotMult: 1.35, effectiveRange: 25, maxRange: 120, fireModes: ['auto', 'single'], 
        bleeding: 0.0309, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['9x39_sp5', '9x39_sp6', '9x39_exp'], 
        stats: { verticalRecoil: 1.05, horizontalRecoil: 0.1, hipSpread: 2.35, adsSpread: 0.9 } 
    },
    { 
        id: 'm60', image: 'm60.png', imageFolder: 'Weapons', name: 'M60', nameEn: 'M60', category: 'machinegun', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 43, rpm: 600, headshotMult: 1.25, effectiveRange: 25, maxRange: 140, fireModes: ['auto', 'single'], 
        bleeding: 0.045, damageFalloff: { end: 140, minScale: 0.8 },
        ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], 
        stats: { verticalRecoil: 1.57, horizontalRecoil: 0.55, hipSpread: 1.22, adsSpread: 0.24 } 
    },
    { 
        id: 'fn2000_bezliky', image: 'fn2000_bezliky.png', imageFolder: 'Weapons', name: 'FN F2000 «Безликий»', nameEn: 'FN F2000 "Faceless"', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', 
        damage: 30, rpm: 850, headshotMult: 1.25, effectiveRange: 26, maxRange: 120, fireModes: ['auto', 'single'], 
        bleeding: 0.0212, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.25, horizontalRecoil: 0.32, hipSpread: 0.96, adsSpread: 0.18 } 
    },
    { 
        id: 'ash12', image: 'ash12.png', imageFolder: 'Weapons', name: 'АШ-12', nameEn: 'ASh-12', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 42, rpm: 600, headshotMult: 1.25, effectiveRange: 20, maxRange: 80, magazine: 20, fireModes: ['auto', 'single'], 
        bleeding: 0.054, damageFalloff: { end: 80, minScale: 0.8 },
        ammoTypes: ['127x55', '127x55_exp'], 
        stats: { verticalRecoil: 2.6, horizontalRecoil: 0.7, hipSpread: 1, adsSpread: 0.22 } 
    },
    { 
        id: 'famas_f1', image: 'famas_f1.png', imageFolder: 'Weapons', name: 'FAMAS F1', nameEn: 'FAMAS F1', category: 'assault', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', 
        damage: 28, rpm: 900, headshotMult: 1.25, effectiveRange: 25, maxRange: 100, fireModes: ['auto', 'single'], 
        bleeding: 0.02, damageFalloff: { end: 100, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.45, horizontalRecoil: 0.41, hipSpread: 0.58, adsSpread: 0.18 } 
    },
    { 
        id: 'ots14_groza', image: 'ots14_groza.png', imageFolder: 'Weapons', name: 'ОЦ-14 «Гроза»', nameEn: 'OTs-14 "Groza"', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', 
        damage: 33, rpm: 750, headshotMult: 1.25, effectiveRange: 19, maxRange: 92, magazine: 20, fireModes: ['auto', 'single'], 
        bleeding: 0.0309, damageFalloff: { end: 92, minScale: 0.8 },
        ammoTypes: ['9x39_sp5', '9x39_sp6', '9x39_exp'], 
        stats: { verticalRecoil: 1.2, horizontalRecoil: 0.34, hipSpread: 0.54, adsSpread: 0.15 } 
    },
    { 
        id: 'grom_545', image: 'grom_545.png', imageFolder: 'Weapons', name: 'ОЦ-14 под 5.45x39', nameEn: 'OTs-14 5.45x39', category: 'assault', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', 
        damage: 33, rpm: 750, headshotMult: 1.25, effectiveRange: 24, maxRange: 110, fireModes: ['auto', 'single'], 
        bleeding: 0.024, damageFalloff: { end: 110, minScale: 0.8 },
        ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp'], 
        stats: { verticalRecoil: 1.41, horizontalRecoil: 0.37, hipSpread: 0.69, adsSpread: 0.15 } 
    },
    { 
        id: 'as_val', image: 'as_val.png', imageFolder: 'Weapons', name: 'АС «Вал»', nameEn: 'AS "Val"', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', 
        damage: 26, rpm: 950, headshotMult: 1.25, effectiveRange: 19, maxRange: 92, magazine: 20, fireModes: ['auto', 'single'], 
        bleeding: 0.024, damageFalloff: { end: 92, minScale: 0.8 },
        ammoTypes: ['9x39_sp5', '9x39_sp6', '9x39_exp'], 
        stats: { verticalRecoil: 1.15, horizontalRecoil: 0.2, hipSpread: 0.62, adsSpread: 0.12 } 
    },
    { 
        id: 'galil_ace_51', image: 'galil_ace_51.png', imageFolder: 'Weapons', name: 'Galil ACE 51', nameEn: 'Galil ACE 51', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 38, rpm: 650, headshotMult: 1.25, effectiveRange: 20, maxRange: 80, magazine: 25, fireModes: ['auto', 'single'], 
        bleeding: 0.0415, damageFalloff: { end: 80, minScale: 0.8 },
        ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], 
        stats: { verticalRecoil: 1.53, horizontalRecoil: 0.49, hipSpread: 0.48, adsSpread: 0.15 } 
    },
    { 
        id: 'sr3_vikhr', image: 'sr3_vikhr.png', imageFolder: 'Weapons', name: 'СР-3 «Вихрь»', nameEn: 'SR-3 "Vikhr"', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', 
        damage: 29, rpm: 850, headshotMult: 1.35, effectiveRange: 19, maxRange: 92, fireModes: ['auto', 'single'], 
        bleeding: 0.0338, damageFalloff: { end: 92, minScale: 0.8 },
        ammoTypes: ['9x39_sp5', '9x39_sp6', '9x39_exp'], 
        stats: { verticalRecoil: 1.36, horizontalRecoil: 0.31, hipSpread: 0.73, adsSpread: 0.18 } 
    },
    { 
        id: 'fn_scar_h', image: 'fn_scar_h.png', imageFolder: 'Weapons', name: 'FN SCAR-H', nameEn: 'FN SCAR-H', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 40, rpm: 600, headshotMult: 1.25, effectiveRange: 25, maxRange: 100, magazine: 20, fireModes: ['auto', 'single'], 
        bleeding: 0.045, damageFalloff: { end: 100, minScale: 0.8 },
        ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], 
        stats: { verticalRecoil: 1.62, horizontalRecoil: 0.64, hipSpread: 0.6, adsSpread: 0.12 } 
    },
    { 
        id: 'm249_saw', image: 'm249_saw.png', imageFolder: 'Weapons', name: 'M249 SAW', nameEn: 'M249 SAW', category: 'machinegun', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', 
        damage: 30, rpm: 800, headshotMult: 1.25, effectiveRange: 20, maxRange: 120, magazine: 200, fireModes: ['auto'], 
        bleeding: 0.0225, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.51, horizontalRecoil: 0.5, hipSpread: 0.7, adsSpread: 0.19 } 
    },
    { 
        id: 'm4', image: 'm4.png', imageFolder: 'Weapons', name: 'M4', nameEn: 'M4', category: 'assault', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', 
        damage: 30, rpm: 785, headshotMult: 1.25, effectiveRange: 26, maxRange: 110, fireModes: ['auto', 'single'], 
        bleeding: 0.0229, damageFalloff: { end: 110, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.37, horizontalRecoil: 0.31, hipSpread: 0.52, adsSpread: 0.2 } 
    },
    { 
        id: 'hk417', image: 'hk417.png', imageFolder: 'Weapons', name: 'HK417', nameEn: 'HK417', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', 
        damage: 39, rpm: 600, headshotMult: 1.25, effectiveRange: 28, maxRange: 120, magazine: 20, fireModes: ['auto', 'single'], 
        bleeding: 0.045, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], 
        stats: { verticalRecoil: 1.55, horizontalRecoil: 0.4, hipSpread: 0.57, adsSpread: 0.11 } 
    },
    { 
        id: 'hk_g3a3', image: 'hk_g3a3.png', imageFolder: 'Weapons', name: 'HK G3A3', nameEn: 'HK G3A3', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', 
        damage: 38, rpm: 600, headshotMult: 1.25, effectiveRange: 25, maxRange: 110, magazine: 20, fireModes: ['auto', 'single'], 
        bleeding: 0.045, damageFalloff: { end: 110, minScale: 0.8 },
        ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], 
        stats: { verticalRecoil: 1.75, horizontalRecoil: 0.59, hipSpread: 0.85, adsSpread: 0.27 } 
    },
    { 
        id: 'rpk74', image: 'rpk74.png', imageFolder: 'Weapons', name: 'РПК-74', nameEn: 'RPK-74', category: 'machinegun', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', 
        damage: 35, rpm: 650, headshotMult: 1.25, effectiveRange: 27, maxRange: 132, fireModes: ['auto', 'single'], 
        bleeding: 0.0277, damageFalloff: { end: 132, minScale: 0.8 },
        ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp'], 
        stats: { verticalRecoil: 1.5, horizontalRecoil: 0.45, hipSpread: 0.45, adsSpread: 0.14 } 
    },
    { 
        id: 'steyr_aug_a3', image: 'steyr_aug_a3.png', imageFolder: 'Weapons', name: 'Steyr AUG A3', nameEn: 'Steyr AUG A3', category: 'assault', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', 
        damage: 32, rpm: 700, headshotMult: 1.25, effectiveRange: 26, maxRange: 120, fireModes: ['auto', 'single'], 
        bleeding: 0.0257, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.36, horizontalRecoil: 0.43, hipSpread: 0.49, adsSpread: 0.1 } 
    },
    { 
        id: 'rpd', image: 'rpd.png', imageFolder: 'Weapons', name: 'РПД', nameEn: 'RPD', category: 'machinegun', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', 
        damage: 34, rpm: 650, headshotMult: 1.25, effectiveRange: 20, maxRange: 110, fireModes: ['auto', 'single'], 
        bleeding: 0.0386, damageFalloff: { end: 110, minScale: 0.8 },
        ammoTypes: ['762x39_ps', '762x39_bp', '762x39_exp'], 
        stats: { verticalRecoil: 1.7, horizontalRecoil: 0.69, hipSpread: 0.85, adsSpread: 0.2 } 
    },
    { 
        id: 'fn_scar_l', image: 'fn_scar_l.png', imageFolder: 'Weapons', name: 'FN SCAR-L', nameEn: 'FN SCAR-L', category: 'assault', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', 
        damage: 34, rpm: 650, headshotMult: 1.25, effectiveRange: 26, maxRange: 120, fireModes: ['auto', 'single'], 
        bleeding: 0.0277, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.19, horizontalRecoil: 0.28, hipSpread: 0.44, adsSpread: 0.12 } 
    },
    { 
        id: 'm4a1', image: 'm4a1.png', imageFolder: 'Weapons', name: 'M4A1', nameEn: 'M4A1', category: 'assault', rarity: 'common', rarityName: 'Распространённое', rarityNameEn: 'Common', 
        damage: 29, rpm: 750, headshotMult: 1.25, effectiveRange: 26, maxRange: 110, fireModes: ['auto', 'single'], 
        bleeding: 0.024, damageFalloff: { end: 110, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.46, horizontalRecoil: 0.42, hipSpread: 0.64, adsSpread: 0.22 } 
    },
    { 
        id: 'm16a4', image: 'm16a4.png', imageFolder: 'Weapons', name: 'M16A4', nameEn: 'M16A4', category: 'assault', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', 
        damage: 29, rpm: 750, headshotMult: 1.25, effectiveRange: 26, maxRange: 110, fireModes: ['auto', 'single'], 
        bleeding: 0.024, damageFalloff: { end: 110, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.4, horizontalRecoil: 0.37, hipSpread: 0.67, adsSpread: 0.24 } 
    },
    { 
        id: '9a91', image: '9a91.png', imageFolder: 'Weapons', name: '9А-91', nameEn: '9A-91', category: 'assault', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', 
        damage: 31, rpm: 700, headshotMult: 1.35, effectiveRange: 19, maxRange: 92, magazine: 20, fireModes: ['auto', 'single'], 
        bleeding: 0.0332, damageFalloff: { end: 92, minScale: 0.8 },
        ammoTypes: ['9x39_sp5', '9x39_sp6', '9x39_exp'], 
        stats: { verticalRecoil: 1.25, horizontalRecoil: 0.3, hipSpread: 2.5, adsSpread: 0.14 } 
    },
    { 
        id: 'ak103', image: 'ak103.png', imageFolder: 'Weapons', name: 'AK-103', nameEn: 'AK-103', category: 'assault', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', 
        damage: 36, rpm: 600, headshotMult: 1.25, effectiveRange: 22, maxRange: 108, fireModes: ['auto', 'single'], 
        bleeding: 0.045, damageFalloff: { end: 108, minScale: 0.8 },
        ammoTypes: ['762x39_ps', '762x39_bp', '762x39_exp'], 
        stats: { verticalRecoil: 1.64, horizontalRecoil: 0.45, hipSpread: 0.6, adsSpread: 0.23 } 
    },
    { 
        id: 'gorn', image: 'gorn.png', imageFolder: 'Weapons', name: '«Горн»', nameEn: '"Gorn"', category: 'assault', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', 
        damage: 27, rpm: 800, headshotMult: 1.25, effectiveRange: 25, maxRange: 100, fireModes: ['auto', 'single'], 
        bleeding: 0.0225, damageFalloff: { end: 100, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.45, horizontalRecoil: 0.41, hipSpread: 0.58, adsSpread: 0.18 } 
    },
    { 
        id: 'ak105', image: 'ak105.png', imageFolder: 'Weapons', name: 'АК-105', nameEn: 'AK-105', category: 'assault', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', 
        damage: 33, rpm: 650, headshotMult: 1.25, effectiveRange: 24, maxRange: 115, fireModes: ['auto', 'single'], 
        bleeding: 0.0277, damageFalloff: { end: 115, minScale: 0.8 },
        ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp'], 
        stats: { verticalRecoil: 1.45, horizontalRecoil: 0.39, hipSpread: 0.65, adsSpread: 0.15 } 
    },
    { 
        id: 'an94_abakan', image: 'an94_abakan.png', imageFolder: 'Weapons', name: 'АН-94 «Абакан»', nameEn: 'AN-94 "Abakan"', category: 'assault', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', 
        damage: 34, rpm: 625, headshotMult: 1.25, effectiveRange: 24, maxRange: 115, fireModes: ['auto', 'single'], 
        bleeding: 0.0288, damageFalloff: { end: 115, minScale: 0.8 },
        ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp'], 
        stats: { verticalRecoil: 1.52, horizontalRecoil: 0.31, hipSpread: 0.72, adsSpread: 0.18 } 
    },
    { 
        id: 'steyr_aug_a1', image: 'steyr_aug_a1.png', imageFolder: 'Weapons', name: 'Steyr AUG A1', nameEn: 'Steyr AUG A1', category: 'assault', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', 
        damage: 31, rpm: 680, headshotMult: 1.25, effectiveRange: 26, maxRange: 120, fireModes: ['auto', 'single'], 
        bleeding: 0.0265, damageFalloff: { end: 120, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.42, horizontalRecoil: 0.5, hipSpread: 0.55, adsSpread: 0.12 } 
    },
    { 
        id: 'akm', image: 'akm.png', imageFolder: 'Weapons', name: 'АКМ', nameEn: 'AKM', category: 'assault', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', 
        damage: 35, rpm: 600, headshotMult: 1.25, effectiveRange: 22, maxRange: 108, fireModes: ['auto', 'single'], 
        bleeding: 0.045, damageFalloff: { end: 108, minScale: 0.8 },
        ammoTypes: ['762x39_ps', '762x39_bp', '762x39_exp'], 
        stats: { verticalRecoil: 1.76, horizontalRecoil: 0.5, hipSpread: 0.8, adsSpread: 0.27 } 
    },
    { 
        id: 'm16a2', image: 'm16a2.png', imageFolder: 'Weapons', name: 'M16A2', nameEn: 'M16A2', category: 'assault', 
        damage: 28, rpm: 750, headshotMult: 1.25, effectiveRange: 26, maxRange: 110, fireModes: ['auto', 'single'], 
        bleeding: 0.024, damageFalloff: { end: 110, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.43, horizontalRecoil: 0.39, hipSpread: 0.79, adsSpread: 0.24 } 
    },
    { 
        id: 'ak74m', image: 'ak74m.png', imageFolder: 'Weapons', name: 'АК-74М', nameEn: 'AK-74M', category: 'assault', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', 
        damage: 32, rpm: 650, headshotMult: 1.25, effectiveRange: 24, maxRange: 115, fireModes: ['auto', 'single'], 
        bleeding: 0.0277, damageFalloff: { end: 115, minScale: 0.8 },
        ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp'], 
        stats: { verticalRecoil: 1.49, horizontalRecoil: 0.45, hipSpread: 0.72, adsSpread: 0.17 } 
    },
    { 
        id: 'sig_sg550', image: 'sig_sg550.png', imageFolder: 'Weapons', name: 'SIG SG 550', nameEn: 'SIG SG 550', category: 'assault', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', 
        damage: 31, rpm: 650, headshotMult: 1.25, effectiveRange: 26, maxRange: 110, fireModes: ['auto', 'single'], 
        bleeding: 0.0277, damageFalloff: { end: 110, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.28, horizontalRecoil: 0.49, hipSpread: 0.62, adsSpread: 0.22 } 
    },
    { 
        id: 'l85a1', image: 'l85a1.png', imageFolder: 'Weapons', name: 'L85A1', nameEn: 'L85A1', category: 'assault', rarity: 'common', rarityName: 'Распространённое', rarityNameEn: 'Common', 
        damage: 30, rpm: 650, headshotMult: 1.25, effectiveRange: 26, maxRange: 115, fireModes: ['auto', 'single'], 
        bleeding: 0.0277, damageFalloff: { end: 115, minScale: 0.8 },
        ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], 
        stats: { verticalRecoil: 1.35, horizontalRecoil: 0.28, hipSpread: 0.64, adsSpread: 0.23 } 
    },
    { 
        id: 'aks74u', image: 'aks74u.png', imageFolder: 'Weapons', name: 'АКС-74У', nameEn: 'AKS-74U', category: 'assault', 
        damage: 30, rpm: 650, headshotMult: 1.25, effectiveRange: 24, maxRange: 110, fireModes: ['auto', 'single'], 
        bleeding: 0.0277, damageFalloff: { end: 110, minScale: 0.8 },
        ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp'], 
        stats: { verticalRecoil: 1.57, horizontalRecoil: 0.46, hipSpread: 0.87, adsSpread: 0.3 } 
    },
    { 
        id: 'aks74', image: 'aks74.png', imageFolder: 'Weapons', name: 'АКС-74', nameEn: 'AKS-74', category: 'assault', rarity: 'common', rarityName: 'Распространённое', rarityNameEn: 'Common', 
        damage: 31, rpm: 600, headshotMult: 1.25, effectiveRange: 24, maxRange: 115, fireModes: ['auto', 'single'], 
        bleeding: 0.03, damageFalloff: { end: 115, minScale: 0.8 },
        ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp'], 
        stats: { verticalRecoil: 1.5, horizontalRecoil: 0.45, hipSpread: 0.85, adsSpread: 0.21 } 
    },

    // SNIPER RIFLES (DMR: 0.9, Bolt-Action: 0.95)
    { id: 'remington_700', image: 'remington_700.png', imageFolder: 'Weapons', name: 'Remington 700', nameEn: 'Remington 700', category: 'sniper', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 126, rpm: 30, headshotMult: 1.5, effectiveRange: 55, fireModes: ['single'], damageFalloff: { end: 340, minScale: 0.95 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 3, horizontalRecoil: 2.15, hipSpread: 5, adsSpread: 0.08 } },
    { id: 'svd', image: 'svd.png', imageFolder: 'Weapons', name: 'Снайперская винтовка Драгунова', nameEn: 'SVD Dragunov', category: 'sniper', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 99, rpm: 111, headshotMult: 1.5, effectiveRange: 40, fireModes: ['single'], damageFalloff: { end: 310, minScale: 0.9 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 6, horizontalRecoil: 2, hipSpread: 5, adsSpread: 0.11 } },
    { id: 'sig_sg550_sniper', image: 'sig_sg550_sniper.png', imageFolder: 'Weapons', name: 'SIG SG 550 Sniper', nameEn: 'SIG SG 550 Sniper', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 32, rpm: 480, headshotMult: 1.35, effectiveRange: 30, magazine: 30, fireModes: ['auto', 'single'], damageFalloff: { end: 260, minScale: 0.9 }, ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], stats: { verticalRecoil: 1.20, horizontalRecoil: 0.35, hipSpread: 1.50, adsSpread: 0.06 } },
    { id: 'walther_wa2000', image: 'walther_wa2000.png', imageFolder: 'Weapons', name: 'Walther WA 2000', nameEn: 'Walther WA 2000', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 120, rpm: 120, headshotMult: 1.5, effectiveRange: 44, magazine: 6, fireModes: ['single'], damageFalloff: { end: 340, minScale: 0.9 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 4.7, horizontalRecoil: 1.54, hipSpread: 5, adsSpread: 0.05, moveSpeed: -3.00 } },
    { id: 'sv98', image: 'sv98.png', imageFolder: 'Weapons', name: 'СВ-98', nameEn: 'SV-98', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 161, rpm: 33, headshotMult: 1.5, effectiveRange: 50, magazine: 5, fireModes: ['single'], damageFalloff: { end: 340, minScale: 0.95 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.55, horizontalRecoil: 3.1, hipSpread: 5, adsSpread: 0.05, moveSpeed: -3.00 } },
    { id: 'sako_trg42', image: 'sako_trg42.png', imageFolder: 'Weapons', name: 'Sako TRG-42', nameEn: 'Sako TRG-42', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 162, rpm: 30, headshotMult: 1.5, effectiveRange: 55, magazine: 5, fireModes: ['single'], damageFalloff: { end: 350, minScale: 0.95 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 4, horizontalRecoil: 3.5, hipSpread: 5, adsSpread: 0.05, moveSpeed: -3.00 } },
    { id: 'barrett_m82', image: 'barrett_m82.png', imageFolder: 'Weapons', name: 'Barrett M82', nameEn: 'Barrett M82', category: 'sniper', rarity: 'legendary', rarityName: 'Легендарное', rarityNameEn: 'Legendary', damage: 150, rpm: 110, headshotMult: 1.45, effectiveRange: 48, fireModes: ['single'], damageFalloff: { end: 360, minScale: 0.9 }, ammoTypes: ['127x55', '127x55_exp'], stats: { verticalRecoil: 6.2, horizontalRecoil: 1.68, hipSpread: 10, adsSpread: 0.05, moveSpeed: -6 } },
    { id: 'm24', image: 'm24.png', imageFolder: 'Weapons', name: 'Снайперская винтовка М24', nameEn: 'M24 Sniper Rifle', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 141, rpm: 35, headshotMult: 1.5, effectiveRange: 55, magazine: 5, fireModes: ['single'], damageFalloff: { end: 350, minScale: 0.95 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 2.75, horizontalRecoil: 1.8, hipSpread: 5, adsSpread: 0.05 } },
    { id: 'mosin_obrez', image: 'mosin_obrez.png', imageFolder: 'Weapons', name: 'Обрез винтовки Мосина', nameEn: 'Mosin Obrez', category: 'sniper', damage: 112, rpm: 20, headshotMult: 1.5, effectiveRange: 20, fireModes: ['single'], damageFalloff: { end: 160, minScale: 0.95 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.65, horizontalRecoil: 2.2, hipSpread: 2, adsSpread: 0.19 } },
    { id: 'mosin', image: 'mosin.png', imageFolder: 'Weapons', name: 'Винтовка Мосина', nameEn: 'Mosin Rifle', category: 'sniper', rarity: 'common', rarityName: 'Распространённое', rarityNameEn: 'Common', damage: 114, rpm: 20, headshotMult: 1.5, effectiveRange: 50, fireModes: ['single'], damageFalloff: { end: 330, minScale: 0.95 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.65, horizontalRecoil: 2.2, hipSpread: 2, adsSpread: 0.08 } },
    ...
    { id: 'l96a1', image: 'l96a1.png', imageFolder: 'Weapons', name: 'L96A1', nameEn: 'L96A1', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 158, rpm: 30, headshotMult: 1.5, effectiveRange: 55, magazine: 5, fireModes: ['single'], damageFalloff: { end: 350, minScale: 0.95 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 2.1, horizontalRecoil: 1, hipSpread: 5, adsSpread: 0.03, moveSpeed: -3.00 } },
    { id: 'svu', image: 'svu.png', imageFolder: 'Weapons', name: 'Снайперская винтовка укороченная', nameEn: 'SVU', category: 'sniper', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 80, rpm: 133, headshotMult: 1.5, effectiveRange: 40, fireModes: ['single'], damageFalloff: { end: 310, minScale: 0.9 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3, horizontalRecoil: 1.5, hipSpread: 5, adsSpread: 0.1 } },
    { id: 'svds', image: 'svds.png', imageFolder: 'Weapons', name: 'СВД-С', nameEn: 'SVDS', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 100, rpm: 120, headshotMult: 1.5, effectiveRange: 40, fireModes: ['single'], damageFalloff: { end: 320, minScale: 0.9 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 5, horizontalRecoil: 1.4, hipSpread: 5, adsSpread: 0.09 } },
    { id: 'mk14_ebr', image: 'mk14_ebr.png', imageFolder: 'Weapons', name: 'Mk14 Enhanced Battle Rifle', nameEn: 'Mk14 EBR', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 50, rpm: 320, headshotMult: 1.35, effectiveRange: 30, magazine: 20, fireModes: ['auto', 'single'], damageFalloff: { end: 300, minScale: 0.9 }, ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], stats: { verticalRecoil: 1.50, horizontalRecoil: 0.25, hipSpread: 1.50, adsSpread: 0.05 } },
    { id: 'sr25', image: 'sr25.png', imageFolder: 'Weapons', name: 'SR-25', nameEn: 'SR-25', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 74, rpm: 230, headshotMult: 1.5, effectiveRange: 44, magazine: 20, fireModes: ['single'], damageFalloff: { end: 310, minScale: 0.9 }, ammoTypes: ['308_winchester', '308_winchester_exp'], stats: { verticalRecoil: 4, horizontalRecoil: 0.55, hipSpread: 5, adsSpread: 0.1 } },
    { id: 'sks', image: 'sks.png', imageFolder: 'Weapons', name: 'СКС', nameEn: 'SKS', category: 'sniper', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', damage: 40, rpm: 460, headshotMult: 1.35, effectiveRange: 34, fireModes: ['single'], damageFalloff: { end: 290, minScale: 0.9 }, ammoTypes: ['762x39_ps', '762x39_bp', '762x39_exp'], stats: { verticalRecoil: 3, horizontalRecoil: 1.5, hipSpread: 1.5, adsSpread: 0.17 } },
    { id: 'vssk_vykhlop', image: 'vssk_vykhlop.png', imageFolder: 'Weapons', name: 'ВССК «Выхлоп»', nameEn: 'VSSK "Vykhlop"', category: 'sniper', rarity: 'legendary', rarityName: 'Легендарное', rarityNameEn: 'Legendary', damage: 162, rpm: 27, headshotMult: 1.5, effectiveRange: 65, magazine: 5, damageFalloff: { end: 360, minScale: 0.95 }, fireModes: ['single'], ammoTypes: ['127x55', '127x55_exp'], stats: { verticalRecoil: 10, horizontalRecoil: 9.5, hipSpread: 5, adsSpread: 0.04, moveSpeed: -4.00 } },
    { id: 'svt40', image: 'svt40.png', imageFolder: 'Weapons', name: 'СВТ-40', nameEn: 'SVT-40', category: 'sniper', rarity: 'common', rarityName: 'Распространённое', rarityNameEn: 'Common', damage: 67, rpm: 120, headshotMult: 1.35, effectiveRange: 40, fireModes: ['single'], damageFalloff: { end: 310, minScale: 0.9 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.3, horizontalRecoil: 1.63, hipSpread: 5, adsSpread: 0.16 } },
    { id: 'avt40', image: 'avt40.png', imageFolder: 'Weapons', name: 'АВТ-40', nameEn: 'AVT-40', category: 'sniper', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', damage: 60, rpm: 230, headshotMult: 1.35, effectiveRange: 40, fireModes: ['auto', 'single'], damageFalloff: { end: 310, minScale: 0.9 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.2, horizontalRecoil: 1.63, hipSpread: 5, adsSpread: 0.19 } },
    ...
    { id: 'vss_vintorez', image: 'vss_vintorez.png', imageFolder: 'Weapons', name: 'ВСС «Винторез»', nameEn: 'VSS "Vintorez"', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 39, rpm: 700, headshotMult: 1.35, effectiveRange: 30, fireModes: ['auto', 'single'], damageFalloff: { end: 280, minScale: 0.8 }, ammoTypes: ['9x39_sp5', '9x39_sp6', '9x39_exp'], stats: { verticalRecoil: 1.05, horizontalRecoil: 0.1, hipSpread: 2.5, adsSpread: 0.12 } },
    { id: 'ots03_svua', image: 'ots03_svua.png', imageFolder: 'Weapons', name: 'ОЦ-03 СВУ-А', nameEn: 'OTs-03 SVU-A', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 57, rpm: 221, headshotMult: 1.35, effectiveRange: 40, fireModes: ['auto'], damageFalloff: { end: 310, minScale: 0.9 }, ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 1.75, horizontalRecoil: 0.87, hipSpread: 5, adsSpread: 0.12 } },
    { id: 'hk_g3sg1', image: 'hk_g3sg1.png', imageFolder: 'Weapons', name: 'HK G3SG-1', nameEn: 'HK G3SG-1', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 50, rpm: 350, headshotMult: 1.35, effectiveRange: 30, magazine: 20, fireModes: ['auto', 'single'], damageFalloff: { end: 280, minScale: 0.9 }, ammoTypes: ['762x51_m59', '762x51_m61', '762x51_exp'], stats: { verticalRecoil: 1.33, horizontalRecoil: 0.25, hipSpread: 1.50, adsSpread: 0.07 } },
    { id: 'gauss_gun', image: 'gauss_gun.png', imageFolder: 'Weapons', name: 'Гаусс-пушка', nameEn: 'Gauss Gun', category: 'sniper', rarity: 'legendary', rarityName: 'Легендарное', rarityNameEn: 'Legendary', damage: 116, rpm: 28, headshotMult: 2, effectiveRange: 70, fireModes: ['single'], damageFalloff: { end: 380, minScale: 0.95 }, ammoTypes: ['makeshift_batteries', 'accumulators'], stats: { verticalRecoil: 0.6, horizontalRecoil: 0, hipSpread: 5, adsSpread: 0.01, moveSpeed: -4 } },

    // PISTOLS (Без изменений)
    ...
    // ADDITIONAL SHOTGUNS & SPECIAL (Без изменений)
